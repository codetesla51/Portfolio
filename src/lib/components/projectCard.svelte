  ...
  <div class="relative z-10 p-8">
    ...
    <div class="flex justify-between items-start mb-6">
      <div class="relative">
        ...
        <div 
          class="relative p-4 bg-gradient-to-br from-sec to-sec/90 rounded-xl border-2 border-acc/40 group-hover:border-acc/70 transition-all duration-300 group-hover:scale-110 group-hover:rotate-3"
          data-aos="zoom-in"
      ...
      <div 
        ...
        data-aos-delay={300 + (index * 50)}
      >
        <div class="w-8 h-0.5 bg-acc/30 group-hover:w-12 group-hover:bg-acc/60 transition-all duration-300"></div>
    ...
    >
      <div class="flex items-center mb-3">
        <svg class="w-4 h-4 text-acc mr-2 group-hover:rotate-12 transition-transform duration-300" fill="currentColor" viewBox="0 0 20 20">
      ...
      <div class="bg-sec/50 rounded-lg p-3 border border-acc/20 group-hover:border-acc/40 group-hover:bg-sec/60 transition-all duration-300">
        <p class="font-mono text-sm text-text/90 group-hover:text-text transition-colors duration-300 leading-relaxed">
